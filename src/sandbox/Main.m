...
saveas(figure1, 'expected_utility.png');
...
plot(xx(xx >= 0), (xx(xx >= 0)).^g, 'LineWidth', 3, 'Color', [0.2, 0.2 0.7])
plot(xx(xx <= 0), -l*(-(xx(xx <= 0))).^g, 'LineWidth', 3, 'Color', [0.2, 0.2 0.7])
plot(xx, xx * 0, 'LineWidth', 3)

hold off
xlim([-10, 10])
xlabel("Gain/Loss", "FontSize", 15)
ylabel("Utility", "FontSize", 15)
